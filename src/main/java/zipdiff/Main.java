...
public class Main {
    ...
    private static final String OPTION_COMPARE_COMPRESSEDSIZES = "comparecompressedsizes";
    ...
    static {
        ...
        Option compareCS =
                new Option(OPTION_COMPARE_COMPRESSEDSIZES, OPTION_COMPARE_COMPRESSEDSIZES, false, "Compare compressed sizes");
        compareTS.setRequired(false);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (line.hasOption(OPTION_COMPARE_COMPRESSEDSIZES)) {
                calc.setCompareCompressedSizes(true);
            } else {
                calc.setCompareCompressedSizes(false);
            }
